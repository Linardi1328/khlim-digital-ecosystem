const en = {
  "enrol.error.loadOfferings": "Unable to load current academy offerings from the KHLIM API.",
  "enrol.error.selectOffering": "Select an available programme offering.",
  "enrol.error.selectPlan": "Select a valid membership plan with configured pricing.",
  "enrol.error.acceptTerms": "Accept the membership terms and any required recurring-billing authorization to continue.",
  ...
  "enrol.header.subtitle": "Programme availability and pricing are loaded from the KHLIM backend.",
  "enrol.signIn.title": "Guardian sign-in required",
  "enrol.signIn.body": "Sign in before creating or selecting a managed athlete.",
  ...
  "enrol.review.subtitle": "Review the server-provided plan before billing authorization.",
  ...
  "enrol.review.recurringAuthorization": "I authorize the recurring installment schedule shown above.",
  ...
  "enrol.payment.description": "Checkout is hosted by the configured payment provider.",
  "enrol.payment.handoffTitle": "Secure provider handoff",
  "enrol.payment.handoffBody": "KHLIM does not render or store card numbers or CVVs. If no provider is configured, your membership remains PENDING and no payment is claimed.",
  ...
  "enrol.summary.apiSource": "Price and eligibility originate from the KHLIM API.",
  "enrol.loading": "Loading enrolment…",
  "enrol.confirmation.verifyMembershipError": "The requested membership could not be verified.",
  "enrol.confirmation.verifyStateError": "Unable to verify enrolment state.",
  "enrol.confirmation.verifying": "Verifying the current membership and billing state with KHLIM…",
  "enrol.confirmation.missingTitle": "Missing enrolment reference",
  "enrol.confirmation.missingBody": "This page requires an athlete and membership reference. Open the membership from your parent portal.",
  "enrol.confirmation.errorTitle": "Unable to verify enrolment state",
  "enrol.confirmation.safetyNotice": "No payment or membership success is being assumed.",
  ...
  "enrol.confirmation.activeBody": "KHLIM has verified the backend membership as ACTIVE.",
  "enrol.confirmation.pendingBody": "The backend currently reports this membership as pending or otherwise not active. Payment is not treated as successful until verified provider processing updates backend state.",
...
const ms: Catalogue = {
  "enrol.error.loadOfferings": "Tidak dapat memuatkan tawaran akademi semasa daripada API KHLIM.",
  "enrol.error.selectOffering": "Pilih tawaran program yang tersedia.",
  "enrol.error.selectPlan": "Pilih pelan keahlian yang sah dengan harga yang dikonfigurasi.",
  "enrol.error.acceptTerms": "Terima syarat keahlian dan sebarang kebenaran pengebilan berulang yang diperlukan untuk meneruskan.",
  ...
  "enrol.header.subtitle": "Ketersediaan program dan harga dimuatkan daripada pelayan KHLIM.",
  "enrol.signIn.title": "Log masuk penjaga diperlukan",
  "enrol.signIn.body": "Log masuk sebelum mencipta atau memilih atlet yang diurus.",
  "enrol.dateOfBirthLabel": "Tarikh lahir",
  "enrol.loadingOfferings": "Memuatkan tawaran…",
  "enrol.noOfferings": "Tiada tawaran program terbuka yang tersedia pada masa ini.",
  ...
  "enrol.review.subtitle": "Semak pelan yang diberikan pelayan sebelum kebenaran pengebilan.",
  ...
  "enrol.review.recurringAuthorization": "Saya membenarkan jadual ansuran berulang yang ditunjukkan di atas.",
  ...
  "enrol.payment.description": "Pembayaran dihoskan oleh penyedia pembayaran yang dikonfigurasi.",
  "enrol.payment.handoffTitle": "Serahan selamat kepada penyedia",
  "enrol.payment.handoffBody": "KHLIM tidak memaparkan atau menyimpan nombor kad atau CVV. Jika tiada penyedia dikonfigurasi, keahlian anda kekal MENUNGGU dan tiada pembayaran didakwa berjaya.",
  ...
  "enrol.confirmation.verifyMembershipError": "Keahlian yang diminta tidak dapat disahkan.",
  "enrol.confirmation.verifyStateError": "Tidak dapat mengesahkan status pendaftaran.",
  "enrol.confirmation.verifying": "Mengesahkan status keahlian dan pengebilan semasa dengan KHLIM…",
  "enrol.confirmation.missingTitle": "Rujukan pendaftaran tiada",
  "enrol.confirmation.missingBody": "Halaman ini memerlukan rujukan atlet dan keahlian. Buka keahlian daripada portal ibu bapa anda.",
  "enrol.confirmation.errorTitle": "Tidak dapat mengesahkan status pendaftaran",
  "enrol.confirmation.safetyNotice": "Tiada kejayaan pembayaran atau keahlian sedang dianggap.",
  "enrol.confirmation.retry": "Cuba pengesahan semula",
  "enrol.confirmation.activeTitle": "Keahlian aktif",
  "enrol.confirmation.pendingTitle": "Keahlian direkodkan — pengaktifan menunggu",
  "enrol.confirmation.activeBody": "KHLIM telah mengesahkan keahlian pada pelayan sebagai AKTIF.",
  "enrol.confirmation.pendingBody": "Pelayan kini melaporkan keahlian ini sebagai menunggu atau belum aktif. Pembayaran tidak dianggap berjaya sehingga pemprosesan penyedia yang disahkan mengemas kini status pelayan.",
...
const zhHans: Catalogue = {
  ...
  "enrol.review.recurringAuthorization": "我授权按上方所示的定期分期计划进行扣款。",
  ...
  "enrol.payment.handoffBody": "KHLIM 不显示或存储银行卡号或 CVV。如果未配置支付服务商，您的会籍会保持待处理状态，系统不会声称付款成功。",
  ...
  "enrol.confirmation.missingBody": "此页面需要学员和会籍引用。请从家长门户打开相应会籍。",
  ...
  "enrol.confirmation.pendingBody": "后端当前报告此会籍仍在等待或尚未生效。只有经验证的支付服务商处理更新后端状态后，系统才会将付款视为成功。",
...
const zhHant: Catalogue = {
  ...
  "enrol.review.recurringAuthorization": "我授權按上方所示的定期分期計劃進行扣款。",
  "enrol.terms.acceptPrefix": "我接受",
  ...
  "enrol.payment.handoffBody": "KHLIM 不顯示或儲存銀行卡號或 CVV。如果未設定支付服務商，您的會籍會保持待處理狀態，系統不會聲稱付款成功。",
  ...
  "enrol.confirmation.missingBody": "此頁面需要學員和會籍參照。請從家長門戶開啟相應會籍。",
  ...
  "enrol.confirmation.pendingBody": "後端目前報告此會籍仍在等待或尚未生效。只有經驗證的支付服務商處理更新後端狀態後，系統才會將付款視為成功。",
...
const hi: Catalogue = {
  "enrol.error.loadOfferings": "KHLIM API से वर्तमान अकादमी विकल्प लोड नहीं किए जा सके।",
  ...
  "enrol.error.acceptTerms": "जारी रखने के लिए सदस्यता शर्तें और आवश्यक आवर्ती-बिलिंग अनुमति स्वीकार करें।",
  ...
  "enrol.header.subtitle": "कार्यक्रम उपलब्धता और मूल्य KHLIM बैकएंड से लोड किए जाते हैं।",
  ...
  "enrol.review.subtitle": "बिलिंग अनुमति से पहले सर्वर द्वारा दी गई योजना की समीक्षा करें।",
  ...
  "enrol.review.recurringAuthorization": "मैं ऊपर दिखाई गई आवर्ती किस्त अनुसूची को अधिकृत करता/करती हूँ।",
  ...
  "enrol.payment.description": "चेकआउट कॉन्फ़िगर किए गए भुगतान प्रदाता द्वारा होस्ट किया जाता है।",
  "enrol.payment.handoffTitle": "सुरक्षित प्रदाता हस्तांतरण",
  "enrol.payment.handoffBody": "KHLIM कार्ड नंबर या CVV प्रदर्शित या संग्रहीत नहीं करता। यदि कोई प्रदाता कॉन्फ़िगर नहीं है, तो आपकी सदस्यता लंबित रहती है और किसी भुगतान को सफल नहीं बताया जाता।",
  ...
  "enrol.confirmation.verifyMembershipError": "अनुरोधित सदस्यता सत्यापित नहीं की जा सकी।",
  "enrol.confirmation.verifyStateError": "नामांकन स्थिति सत्यापित नहीं की जा सकी।",
  "enrol.confirmation.verifying": "KHLIM के साथ वर्तमान सदस्यता और बिलिंग स्थिति सत्यापित की जा रही है…",
  "enrol.confirmation.missingTitle": "नामांकन संदर्भ गायब है",
  "enrol.confirmation.missingBody": "इस पेज के लिए खिलाड़ी और सदस्यता संदर्भ आवश्यक हैं। अपने अभिभावक पोर्टल से सदस्यता खोलें।",
  "enrol.confirmation.errorTitle": "नामांकन स्थिति सत्यापित नहीं की जा सकी",
  "enrol.confirmation.safetyNotice": "किसी भुगतान या सदस्यता की सफलता मानकर नहीं चली जा रही है।",
  ...
  "enrol.confirmation.activeBody": "KHLIM ने बैकएंड सदस्यता को सक्रिय के रूप में सत्यापित किया है।",
  "enrol.confirmation.pendingBody": "बैकएंड अभी इस सदस्यता को लंबित या अन्यथा निष्क्रिय बता रहा है। भुगतान को तब तक सफल नहीं माना जाता जब तक सत्यापित प्रदाता प्रोसेसिंग बैकएंड स्थिति अपडेट न कर दे।",
...
export const enrolWebMessages = { en, ms, "zh-Hans": zhHans, "zh-Hant": zhHant, hi } as const;
