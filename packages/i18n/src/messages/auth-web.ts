const en = {
  ...
  "auth.register.error.invalid": "Enter your name, a valid email, and a password of at least 8 characters.",
  "auth.register.error.failed": "Registration failed.",
  "auth.register.verifyTitle": "Verify your email to continue",
  "auth.register.verifyBody": "Supabase requires email confirmation for {email}. Open the verification email, then sign in to finish your guardian profile.",
  ...
  "auth.forgot.sentBody": "If an account exists for {email}, a secure password reset link has been dispatched via Supabase Auth.",
  ...
  "auth.reset.unavailableBody": "Open this page from the latest password-recovery email. If the link has expired, request another reset link.",
  "auth.reset.newPassword": "New password",
  "auth.reset.confirmPassword": "Confirm new password",
  "auth.reset.submit": "Update password",
  "onboarding.guardian.error.displayName": "Please provide a guardian display name.",
  "onboarding.guardian.error.save": "Unable to save guardian profile.",
  "onboarding.guardian.phoneHelper": "Optional contact number stored in your KHLIM guardian profile.",
} as const;
...
const ms: Catalogue = {
  ...
  "auth.register.error.invalid": "Masukkan nama, emel yang sah dan kata laluan sekurang-kurangnya 8 aksara.",
  "auth.register.error.failed": "Pendaftaran gagal.",
  "auth.register.verifyTitle": "Sahkan emel anda untuk meneruskan",
  "auth.register.verifyBody": "Supabase memerlukan pengesahan emel untuk {email}. Buka emel pengesahan, kemudian log masuk untuk melengkapkan profil penjaga anda.",
  ...
  "auth.forgot.sentBody": "Jika akaun wujud untuk {email}, pautan tetapan semula kata laluan yang selamat telah dihantar melalui Supabase Auth.",
  "auth.forgot.emailPlaceholder": "penjaga@example.com",
  "auth.reset.error.minimum": "Kata laluan mesti mengandungi sekurang-kurangnya 8 aksara.",
  ...
  "auth.reset.unavailableBody": "Buka halaman ini daripada emel pemulihan kata laluan yang terkini. Jika pautan telah tamat tempoh, minta pautan tetapan semula yang baharu.",
  ...
  "onboarding.guardian.phoneHelper": "Nombor hubungan pilihan yang disimpan dalam profil penjaga KHLIM anda.",
};
...
const zhHans: Catalogue = {
  ...
  "auth.register.error.invalid": "请输入姓名、有效电子邮箱以及至少 8 个字符的密码。",
  "auth.register.error.failed": "注册失败。",
  "auth.register.verifyTitle": "请验证电子邮箱以继续",
  "auth.register.verifyBody": "Supabase 要求验证 {email}。请打开验证邮件，然后登录以完成监护人资料。",
  "auth.register.minimumPassword": "至少 8 个字符。",
  "auth.forgot.error.failed": "密码恢复请求失败。",
  "auth.forgot.sentTitle": "恢复链接已发送",
  "auth.forgot.sentBody": "如果 {email} 对应的账户存在，Supabase Auth 已发送安全的密码重置链接。",
  "auth.forgot.emailPlaceholder": "guardian@example.com",
  ...
  "auth.reset.unavailableBody": "请从最新的密码恢复邮件打开此页面。如果链接已过期，请重新申请重置链接。",
  ...
  "onboarding.guardian.phoneHelper": "可选联系电话，将保存在您的 KHLIM 监护人资料中。",
};
...
const zhHant: Catalogue = {
  ...
  "auth.register.error.invalid": "請輸入姓名、有效電子郵箱以及至少 8 個字元的密碼。",
  "auth.register.error.failed": "註冊失敗。",
  "auth.register.verifyTitle": "請驗證電子郵箱以繼續",
  "auth.register.verifyBody": "Supabase 要求驗證 {email}。請開啟驗證郵件，然後登入以完成監護人資料。",
  "auth.register.minimumPassword": "至少 8 個字元。",
  "auth.forgot.error.failed": "密碼復原請求失敗。",
  "auth.forgot.sentTitle": "復原連結已傳送",
  "auth.forgot.sentBody": "如果 {email} 對應的帳戶存在，Supabase Auth 已傳送安全的密碼重設連結。",
  "auth.forgot.emailPlaceholder": "guardian@example.com",
  ...
  "auth.reset.unavailableBody": "請從最新的密碼復原郵件開啟此頁面。如果連結已過期，請重新申請重設連結。",
  ...
  "onboarding.guardian.phoneHelper": "可選聯絡電話，將儲存在您的 KHLIM 監護人資料中。",
};
...
const hi: Catalogue = {
  ...
  "auth.register.error.invalid": "अपना नाम, मान्य ईमेल और कम से कम 8 अक्षरों का पासवर्ड दर्ज करें।",
  "auth.register.error.failed": "पंजीकरण विफल रहा।",
  "auth.register.verifyTitle": "जारी रखने के लिए अपना ईमेल सत्यापित करें",
  "auth.register.verifyBody": "Supabase को {email} के लिए ईमेल पुष्टि चाहिए। सत्यापन ईमेल खोलें, फिर अपनी अभिभावक प्रोफ़ाइल पूरी करने के लिए साइन इन करें।",
  ...
  "auth.forgot.sentBody": "यदि {email} के लिए खाता मौजूद है, तो Supabase Auth ने सुरक्षित पासवर्ड रीसेट लिंक भेज दिया है।",
  "auth.forgot.emailPlaceholder": "guardian@example.com",
  ...
  "auth.reset.unavailableBody": "इस पेज को नवीनतम पासवर्ड-रिकवरी ईमेल से खोलें। यदि लिंक समाप्त हो गया है, तो नया रीसेट लिंक माँगें।",
  ...
  "onboarding.guardian.phoneHelper": "वैकल्पिक संपर्क नंबर जो आपकी KHLIM अभिभावक प्रोफ़ाइल में सहेजा जाता है।",
};

export const authWebMessages = { en, ms, "zh-Hans": zhHans, "zh-Hant": zhHant, hi } as const;
