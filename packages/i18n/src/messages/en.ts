export const en = {
  // Navigation & Brand
  "brand.name": "KHLIM",
  "brand.tagline": "Digital Sports Ecosystem",
  "brand.academy": "KHLIM Basketball Academy",
  "nav.home": "Home",
  "nav.academy": "Academy",
  ...
  "hero.feature.coaching": "FIBA-Certified Coaches",
  "hero.feature.venues": "Premium Indoor Courts",
  "hero.feature.portal": "Parent Self-Service Portal",
  "hero.feature.development": "Structured Skill Pathway",
  ...
  "programmes.viewDetails": "View Offering",
  "programmes.spotsLeft": "{count} spots remaining",
  "programmes.soldOut": "Fully Booked",
  "programmes.enrolNow": "Enrol for this Offering",
  ...
  "onboarding.guardian.submit": "Save & Continue to Enrolment",

  // Enrolment Wizard
  "enrol.steps.player": "1. Player",
  "enrol.steps.programme": "2. Programme",
  "enrol.steps.plan": "3. Package",
  ...
  // Member Portal
  "portal.dashboard.title": "Parent Dashboard",
  "portal.dashboard.welcome": "Welcome back, {name}",
  "portal.dashboard.selectChild": "Active Player",
  "portal.dashboard.nextTraining": "Next Training Session",
  "portal.dashboard.membershipStatus": "Membership Status",
  "portal.dashboard.nextPayment": "Next Payment Due",
  "portal.dashboard.recentActivity": "Recent Notifications & Updates",
  "portal.players.title": "Managed Players",
  "portal.players.subtitle": "Children linked to your guardian account.",
  "portal.players.addChild": "Add Player Profile",
  "portal.membership.title": "Academy Membership",
  "portal.membership.activePlan": "Active Plan",
  "portal.membership.startDate": "Started",
  ...
  "portal.notifications.empty": "No notifications right now.",
  "portal.account.title": "Account Settings",
  "portal.account.profile": "Guardian Profile",
  "portal.account.language": "Preferred Language",
  "portal.account.security": "Security & Password",
