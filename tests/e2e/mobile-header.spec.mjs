...
test.describe("mobile public header", () => {
  test.beforeEach(async ({ page, viewport }) => {
    test.skip(!viewport || viewport.width > 500, "Mobile header acceptance only");
    await page.goto("/", { waitUntil: "domcontentloaded" });
  });

  test("keeps language, menu, login, and registration actions visible", async ({
    page,
  }) => {
  ...
  test("changes language directly from the top bar without opening the menu", async ({
    page,
  }) => {
