...
test(
  "Phase 2 programme creation uses organization-scoped persisted backend state",
  async () => {
...
test(
  "Phase 2 preserves explicit demo isolation instead of silently treating demo writes as persisted",
  async () => {
    const api = await read("apps/admin/lib/admin-api.ts");
