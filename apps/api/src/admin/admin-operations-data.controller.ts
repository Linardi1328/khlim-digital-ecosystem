...
export class AdminOperationsDataController {
  ...
  @RequireAnyRole(...ACADEMY_MANAGEMENT_ROLES)
  @ApiOperation({
    summary: "List persisted programmes for the current organization",
  })
  ...
  @RequireAnyRole(...ACADEMY_MANAGEMENT_ROLES)
  @ApiOperation({
    summary: "List persisted programme offerings for the current organization",
  })
  ...
  @RequireAnyRole(...ACADEMY_MANAGEMENT_ROLES)
  @ApiOperation({
    summary: "List persisted membership plans for the current organization",
  })
  ...
  @ApiOperation({
    summary: "List persisted memberships for the current organization",
  })
  ...
  @RequireAnyRole(...PLAYER_OPERATIONS_ROLES)
  @ApiOperation({
    summary: "List athletes participating in the current organization",
  })
  ...
  @RequireAnyRole(...PLAYER_OPERATIONS_ROLES)
  @ApiOperation({
    summary: "List guardians linked to athletes in the current organization",
  })
  ...
  @ApiOperation({
    summary: "List persisted payments for the current organization",
  })
  ...
  @RequireAnyRole(...ACADEMY_MANAGEMENT_ROLES)
  @ApiOperation({
    summary: "List persisted venues for the current organization",
  })
  ...
  @ApiOperation({
    summary: "List persisted training sessions for the current organization",
  })
  ...
  @ApiOperation({
    summary:
      "List staff memberships and assigned roles for the current organization",
  })
