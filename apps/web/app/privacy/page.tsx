  ...
  const englishSections: LegalSection[] = [
    {
      ...
      paragraphs: [
        <>
          ...
          member portal. Privacy enquiries may be sent to {contact} or through the{" "}
    ...
    {
      title: "4. Children and guardian consent",
      paragraphs: [
    ...
    {
      title: "5. Who may receive the data",
      paragraphs: [
    ...
    {
      title: "6. Transfers outside Malaysia",
      paragraphs: [
    ...
    {
      title: "8. Access, correction and other requests",
      paragraphs: [
  ...
  const malaySections: LegalSection[] = [
    {
      ...
      paragraphs: [
        <>
          ...
          portal ahli. Pertanyaan privasi boleh dihantar ke {contact} atau melalui{" "}
    ...
    {
      title: "4. Kanak-kanak dan persetujuan penjaga",
      paragraphs: [
    ...
    {
      title: "5. Pihak yang mungkin menerima data",
      paragraphs: [
    ...
    {
      title: "6. Pemindahan data ke luar Malaysia",
      paragraphs: [
    ...
    {
      title: "7. Penyimpanan dan pemadaman",
      paragraphs: [
    ...
    {
      title: "8. Akses, pembetulan dan permintaan lain",
      paragraphs: [
    ...
    {
      title: "9. Keselamatan dan pelanggaran data",
      paragraphs: [
    ...
    {
      title: "10. Kuki dan teknologi serupa",
      paragraphs: [
        <>
